...
public class Oval extends Shape
{
    ...
    {
        int xCenter = this.location[0].x;
        int yCenter = this.location[0].y;
        
        int xCorner = xCenter - (this.diameter1/2);
        int yCorner = yCenter - (this.diameter2/2);
        
        graphics.setColor(this.getColor());
        
        if(this.isFilled() == true)
        {
            graphics.fillOval(xCorner, yCorner, this.diameter1, this.diameter2);
        }
        else
        {
            graphics.drawOval(xCorner, yCorner, this.diameter1, this.diameter2);
        }
